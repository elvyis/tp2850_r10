...
#define	BOOL				bit //BYTE				// boolean flag
...
#define		SYSTEM_USE_DAC_OUT		0	// "1" for use DAC, "0" for no use DAC
...
#define		VGA_SOURCE_EXTENSION	0	// "1" for extension, "0" for representative
