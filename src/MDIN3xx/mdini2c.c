...
extern void I2CWriteData(BYTE value);
extern BYTE I2CReadData(void);
extern BYTE I2CReadDataWithACK(void);
extern BYTE I2CReadDataWithNAK(void);
extern void I2CStop(void);
extern void delay1(WORD);
// ----------------------------------------------------------------------
...
//	I2CStart();
//	I2CWriteData(I2C_MDIN3xx_ADDR);
//	I2CWriteData(rAddr>>8);
//	I2CWriteData(rAddr&0xff);
	I2CSA = I2C_MDIN3xx_ADDR;
	I2CBUF = (rAddr>>8);
	I2CCR = 0x03;
	delay1(300);		
	...
	I2CCR = 0x01;
	delay1(300);
	for (i=0; i<bytes/2-1; i++) {	// for multi register write
//		// 7. i2c write data byte 1 (MSB) D(15:8)
//		// 8. i2c write data byte 0 (MSB) D(7:0)
//		I2CWriteData(HIBYTE(((PWORD)pBuff)[i]));
//		I2CWriteData(LOBYTE(((PWORD)pBuff)[i]));
	I2CBUF = HIBYTE(((PWORD)pBuff)[i]);
	I2CCR = 0x01;
	delay1(500);	
	I2CBUF = LOBYTE(((PWORD)pBuff)[i]);
	I2CCR = 0x01;
	delay1(500);				
	}
	I2CBUF = HIBYTE(((PWORD)pBuff)[i]);
...
//	I2CWriteData(rAddr&0xff);
//	I2CReStart();
//	I2CWriteData(I2C_MDIN3xx_ADDR | 0x01);
	I2CSA = I2C_MDIN3xx_ADDR;
	I2CBUF = rAddr>>8;
	I2CCR = 0x03;
	delay1(300);
	...
	I2CSA = I2C_MDIN3xx_ADDR | 0x01;
	I2CCR = 0x03;
	delay1(500);	
	for (i=0; i<bytes/2-1; i++) { // for multi register read
		// 7. i2c read data byte 1 (MSB) D(15:8)
		// 8. i2c read data byte 0 (MSB) D(7:0)
		((PWORD)pBuff)[i] = (WORD)I2CBUF<<8;
		I2CCR = 0x01;
		delay1(500);		
		((PWORD)pBuff)[i] |= (WORD)I2CBUF;
		I2CCR = 0x01;
		delay1(500);
	}
		((PWORD)pBuff)[i] = (WORD)I2CBUF<<8;
