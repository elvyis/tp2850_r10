 ...
 void CreateMDIN340VideoInstance(void)
{
	...
	MDIN3xx_EnableFrontNRFilter(ON);		// set frontNR on
...
switch(ManVidRes)
	{
		...
		stVideo.stSRC_a.frmt = VIDSRC_1920x1080p50;
		...
		case TP2802_960P25:		
					if(en_960P)
					{
						stVideo.stSRC_a.frmt = VIDSRC_1280x960p30;
						stVideo.stOUT_m.frmt = VIDOUT_1280x960p60;						
					}
					else
					{
		...
		stVideo.stSRC_a.frmt = VIDSRC_1280x720p50;
		stVideo.stOUT_m.frmt = VIDOUT_1280x720p50;
		break;
    ...
    case TP2802_NTSC:
		...
		break;
		case TP2802_PAL:
		stVideo.stSRC_a.frmt = VIDSRC_720x576i50;
		stVideo.stOUT_m.frmt = VIDOUT_1280x720p50;
		break;

		case TP2802_1280x320P60:
		stVideo.stSRC_a.frmt = VIDSRC_1280x320p60;
		stVideo.stOUT_m.frmt = VIDOUT_1280x720p60;
		break;		

		case TP2802_480P20:
		stVideo.stSRC_a.frmt = VIDSRC_1024x518p60;
		stVideo.stOUT_m.frmt = VIDOUT_1280x720p60;
		break;				
	}
	...
	{	
		...
		//stVideo.stSRC_a.mode = MDIN_SRC_SEP656_8;
	}
...
//	stVideo.stMAP_m.frmt = MDIN_MAP_AUX_OFF_NR_OFF;	// when MDIN_DEINT_3DNR_OFF
	...
	stVideo.stSRC_b.frmt = VIDSRC_1280x720p50;
	...
	stVideo.stOUT_x.frmt = VIDOUT_1280x720p50;
	...
	//if(MDIN_debug) 
	MDIN3xx_SetSrcTestPattern(&stVideo, MDIN_IN_TEST_H_RAMP);
	MDIN3xx_SetSrcTestPattern(&stVideo, MDIN_IN_TEST_DISABLE);
	//if(MDIN_debug) 
